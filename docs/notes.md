...
???+ info "Probability Theory"
    **Description**  
    Personal notes on probability with a measure-theoretic approach. This draft covers three pillars: measure theory, the Fourier analysis tools that recur throughout probability, and core probability theory, including classical distributions, conditioning, and limit theorems. Future revisions will add stochastic processes, applications to statistics and machine learning, and selected advanced topics such as large deviation theory.
