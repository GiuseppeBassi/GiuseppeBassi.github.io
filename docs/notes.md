<!-- MAINTENANCE BANNER START (rimuovi questo blocco quando l'aggiornamento è completo) -->
<div class="maintenance-banner">
  🚧 This site is currently being updated — please check back in a few hours.
</div>
...
???+ info "Probability Theory"
    **Description**  
    Personal notes on probability with a measure-theoretic approach. This draft covers three pillars: measure theory, the Fourier analysis tools that recur throughout probability, and core probability theory (classical distributions, conditioning, limit theorems). Future revisions will add stochastic processes, applications to statistics and machine learning, and large deviation theory.

    **Notes & Updates**  
    - **Current version:** 11 Mar 2026  

    **Download**  
    <a class="download-link" href="../assets/PROBABILITY_THEORY.pdf" download>Download *Probability Theory*</a>
...
!!! tip "Coming soon"
    ...
    - *Later in the future:* Probability (continued), ODEs, Analysis 2  
    <br>Stay tuned.
